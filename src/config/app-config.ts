...
export const APP_CONFIG = {
  ...
  logo: {
    ...
    // Logo para tema oscuro (mismo logo funciona para ambos temas)
    ...
    alt: "Parking Admin Logo",
    fallbackText: "A", // Texto que se muestra si no hay logo (A de Admin)
  },

  // App information
  app: {
    name: "Parking Admin - Sistema de Administración",
    shortName: "Parking Admin",
    description: "Sistema de administración para gestión de estacionamiento",
    themeColor: "#304673", // Color principal de la app
...
export function generateDefaultLogoSVG(text = "A", size = 100, isDark = false): string {
  const bgColor = isDark ? "%23ffffff" : "%23304673"
